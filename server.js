...
function addingToDB(req,res){
  let sql='INSERT INTO potter (image,name, patronus, alive)VALUES ($1,$2,$3,$4);';
...
function readingFromDB(req,res){
  let sql='select image, name ,patronus,alive from potter;';
  client.query(sql).then(data=>{
      console.log('inside reading from db');
